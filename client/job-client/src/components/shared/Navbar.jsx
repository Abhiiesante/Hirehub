                        ...
                        {user ? (
                                ...
                                <ul className="flex font-sans items-center space-x-6 text-gray-300">
                                    {user && user.role === 'recruiter' ? (
                                        ...
                                        <>
                                            ...
                                            <Link to='/coursespage'><li className='cursor-pointer hover:text-white font-bold'>Courses</li></Link>
                                            <Link to='/quizzes'><li className='cursor-pointer hover:text-white font-bold'>Quiz</li></Link>
                                            <Link to='/roadmap'><li className='cursor-pointer hover:text-white font-bold'>Roadmaps</li></Link>
                                            <Link to='/resume'><li className='cursor-pointer hover:text-white font-bold'>Resume</li></Link>
                            ...
                            <>
                                <ul className="flex font-sans items-center space-x-6 text-gray-300">
                                    ...
                                    <Link to="/coursespage">
                                        <li className="cursor-pointer hover:text-white font-bold">Courses</li>
                                    </Link>
                                    <Link to="/quizzes">
                                        <li className="cursor-pointer hover:text-white font-bold">Quiz</li>
                                    </Link>
                                    <Link to="/roadmap">
                                        <li className="cursor-pointer hover:text-white font-bold">Roadmaps</li>
                                    </Link>
                                    <Link to="/resume">
                                        <li className="cursor-pointer hover:text-white font-bold">Resume</li>
                                    </Link>
                                    <Link to="/browse">
